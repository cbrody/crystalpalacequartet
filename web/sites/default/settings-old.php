 ...
 */
 $settings['trusted_host_patterns'] = array(
   '^cpq_old\.dd$',
   '^cpq\.ukf\.cbrody\.com$',
   '^.+\.crystalpalacequartet\.co\.uk$',
   '^.+\.crystalpalacequartet\.uk$'
 );
/**
...
$config_directories['sync'] = 'sites/default/files/config_G0HmnMR7Bj67Q_pZ2g-vjHV90EjcZK5_ZQiSjiHhWjdnZUsPFy20BDnw0Qakc9I8Mig3e8GKGQ/sync';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_cpq_old_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_cpq_old_dd.inc';
}
// </DDSETTINGS>
